...
Route::post('/register', [AuthController::class, 'register']);//Invokes the register method in AuthController to handle user registration.
Route::post('/login', [AuthController::class, 'login']);//Invokes the login method in AuthController to handle user login.
...
Route::middleware(['auth:sanctum'])->group(function () {
    Route::post('/logout', [AuthController::class, 'logout']);//Invokes the logout method in AuthController to handle logging out the authenticated user.

    Route::middleware('is-admin')->group(function () {//further protected by the is-admin middleware, ensuring only admin users can access them.
        // Admin routes
    });
